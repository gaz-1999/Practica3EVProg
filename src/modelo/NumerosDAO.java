...
//-----------------------------CONSTRUCTORES------------------------------------
    public NumerosDAO(int id, Image imagen) {
        this.id = id;
        this.imagen = imagen;
    }
...
//-----------------------------MÉTODOS------------------------------------------
    public ArrayList<JButton> generarBotones(ArrayList formitas) {
        listaBotones = new ArrayList<>();
        for (int i = 0; i < formitas.size(); i++) {
            NumerosDAO temp = new NumerosDAO();
            temp = (NumerosDAO) formitas.get(i);
